    ...
    >
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="{{ route('home') }}" class="d-lg-none">
                <img
                    alt="Logo"
                    src="{{ Vite::asset('resources/media/logos/default-small.svg') }}"
                    class="h-30px"
                />
            </a>
        </div>
        ...
        >
            ...
            <div class="app-navbar flex-shrink-0">
                <div class="app-navbar-item ms-1 ms-md-4">
                    ...
                    >
                        <div
                            ...
                            style="
                        background-image: url('{{ Vite::asset('resources/media/misc/menu-header-bg.jpg') }}'
                        );
                      "
                        >
                ...
                >
                    ...
                    >
                        <img
                            src="{{  Vite::asset('resources/media/avatars/300-3.jpg') }}"
                            class="rounded-3"
                            alt="user"
                        />
                    </div>
                    ...
                    >
                        ...
                        >Language
                          ...
                          >Việt Nam
                            <img
                                ...
                                src="{{ Vite::asset('resources/media/flags/vietnam.svg') }}"
                                alt=""/></span
                          ></span>
                            </a>
                            ...
                            <span class="symbol symbol-20px me-4">
                              <img
                                  class="rounded-1"
                                  src="{{ Vite::asset('resources/media/flags/united-states.svg') }}"
                                  alt=""
                              /> </span
                            >English</a
                                    >
                        ...
                        <div class="menu-item px-5">
                            <a href="{{ route('logout') }}"
                               onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="menu-link px-5">
                                Logout
                            </a>
