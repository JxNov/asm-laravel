            ...
            <div class="row space-db--30">
                <div class="col-lg-6 mb--30">
                    <a href="#" class="promo-image promo-overlay">
                        <img src="{{Vite::asset('resources/images/bg-images/promo-banner-with-text.jpg')}}" alt="">
                    </a>
                </div>
                <div class="col-lg-6 mb--30">
                    <a href="#" class="promo-image promo-overlay">
                        <img src="{{Vite::asset('resources/images/bg-images/promo-banner-with-text-2.jpg')}}" alt="">
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="blog-slider sb-slick-slider" data-slick-setting='{
                ...
                <div class="single-slide">
                    <div class="blog-card">
                        <div class="image">
                            <img src="{{Vite::asset('resources/images/others/blog-grid-1.jpg')}}" alt="">
                        </div>
                        <div class="content">
                ...
                <div class="single-slide">
                    <div class="blog-card">
                        <div class="image">
                            <img src="{{Vite::asset('resources/images/others/blog-grid-2.jpg')}}" alt="">
                        </div>
                        <div class="content">
                            <div class="content-header">
                                <div class="date-badge">
                ...
                <div class="single-slide">
                    <div class="blog-card">
                        <div class="image">
                            <img src="{{Vite::asset('resources/images/others/blog-grid-3.jpg')}}" alt="">
                        </div>
                        <div class="content">
                            <div class="content-header">
                                <div class="date-badge">
