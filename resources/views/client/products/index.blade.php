...
@section('content')
    @include('blocks.breadcrumb', ['title' => 'Shop'])
                            ...
                            <div class="product-card card-style-list">
                                <div class="product-grid-content">
                                    <div class="product-header">
                                        ...
                                        <h3><a href="{{ route('products.show', '1') }}">Here Is A Quick Cure For Book</a></h3>
                                    </div>
                                    <div class="product-card--body">
                                        <div class="card-image">
                                            <img src="{{ Vite::asset('resources/images/products/product-2.jpg') }}" alt="">
                                            <div class="hover-contents">
                                                <a href="{{ route('products.show', '1') }}" class="hover-image">
                                ...
                                <div class="product-list-content">
                                    ...
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            ...
                                            <h3><a href="{{ route('products.show', '1') }}" tabindex="0">Qpple cPad with Retina
                            ...
                            <div class="product-card card-style-list">
                                <div class="product-grid-content">
                                    <div class="product-header">
                                        ...
                                        <h3><a href="{{ route('products.show', '1') }}">Simple Things You To Save BOOK</a></h3>
                                    </div>
                                    <div class="product-card--body">
                                        <div class="card-image">
                                ...
                                <div class="product-list-content">
                                    ...
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            ...
                                            <h3><a href="{{ route('products.show', '1') }}" tabindex="0">Apple iPad with Retina
                                                    Display MD510LL/A</a></h3>
                                        </div>
                                        <article>
                                            <h2 class="sr-only">Card List Article</h2>
                            ...
                            <div class="product-card card-style-list">
                                <div class="product-grid-content">
                                    <div class="product-header">
                                        ...
                                        <h3><a href="{{ route('products.show', '1') }}">3 Ways Create Better BOOK With</a></h3>
                                    </div>
                                    <div class="product-card--body">
                                        <div class="card-image">
                            ...
                            <div class="product-card card-style-list">
                                <div class="product-grid-content">
                                    <div class="product-header">
                                        ...
                                        <h3><a href="{{ route('products.show', '1') }}">How Deal With Very Bad BOOK</a></h3>
                                    </div>
                                    <div class="product-card--body">
                                        <div class="card-image">
                            ...
                            <div class="product-card card-style-list">
                                <div class="product-grid-content">
                                    <div class="product-header">
                                        ...
                                        <h3><a href="{{ route('products.show', '1') }}">The Hidden Mystery Behind</a></h3>
                                    </div>
                                    <div class="product-card--body">
                                        <div class="card-image">
                                            <img src="{{ Vite::asset('resources/images/products/product-10.jpg') }}" alt="">
                            ...
                            <div class="product-card card-style-list">
                                <div class="product-grid-content">
                                    <div class="product-header">
                                        ...
                                        <h3><a href="{{ route('products.show', '1') }}">Little Known Ways To Rid Yourself</a>
                                        </h3>
                                    </div>
                                    <div class="product-card--body">
                                        <div class="card-image">
                            ...
                            <div class="product-card card-style-list">
                                <div class="product-grid-content">
                                    <div class="product-header">
                                        ...
                                        <h3><a href="{{ route('products.show', '1') }}">Qple GPad with Retina Sisplay</a></h3>
                                    </div>
                                    <div class="product-card--body">
                                        <div class="card-image">
                                            <img src="{{ Vite::asset('resources/images/products/product-2.jpg') }}" alt="">
                    ...
                    <div class="inner-page-sidebar">
                        ...
                        <div class="single-block">
                            <a href="#" class="promo-image sidebar">
                                <img src="{{ Vite::asset('resources/images/others/home-side-promo.jpg') }}" alt="">
                            </a>
                        </div>
                    </div>
                </div>
