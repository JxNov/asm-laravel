...
@section('content')
    @include('blocks.breadcrumb', ['title' => 'Cart'])
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="pro-thumbnail"><a href="#"><img
                                                    src="{{ Vite::asset('resources/images/products/product-1.jpg') }}" alt="Product"></a></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pro-thumbnail"><a href="#"><img
                                                    src="{{ Vite::asset('resources/images/products/product-2.jpg') }}" alt="Product"></a></td>
                                        <td class="pro-title"><a href="#">Rinosin Glasses</a></td>
                                        <td class="pro-price"><span>$395.00</span></td>
                                        <td class="pro-quantity">
                                            <div class="pro-qty">
                    ...
                    <div class="col-lg-6 col-12 d-flex">
                        <div class="cart-summary">
                            ...
                            <div class="cart-summary-button">
                                <a href="{{ route('products.checkout') }}" class="checkout-btn c-btn btn--primary">Checkout</a>
